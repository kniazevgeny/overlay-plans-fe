...
const Dialog = ({
  ...
  className,
  ...props
}: preact.ComponentProps<typeof DialogPrimitive>) => {
  return (
    <DialogPrimitive
      role={role}
      className={twMerge(
...
const Trigger = (props: preact.ComponentProps<typeof ButtonPrimitive>) => (
...
interface DialogTitleProps extends Omit<HeadingProps, "level"> {
  level?: 1 | 2 | 3 | 4;
  ref?: preact.Ref<HTMLHeadingElement>;
  className?: string;
...
type DialogDescriptionProps = preact.ComponentProps<"div"> & {
  className?: string;
};
...
type DialogBodyProps = preact.ComponentProps<"div"> & {
  className?: string;
};
...
type DialogFooterProps = preact.ComponentProps<"div"> & {
  className?: string;
};
