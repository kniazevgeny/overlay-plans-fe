          ...
          {(date: DateValue) => (
            <CalendarCell
              ...
              className={composeRenderProps(
                ...
                (
                  className,
                  renderProps: { isSelected: boolean; isDisabled: boolean }
                ) =>
                  twMerge(
                    ...
                    renderProps.isDisabled &&
                      "text-muted-fg forced-colors:text-[GrayText]",
                    date.compare(now) === 0 &&
...
const CalendarHeader = ({
  ...
  const state = useContext(CalendarStateContext) as CalendarState;
